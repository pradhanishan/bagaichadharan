...
const NavigationDrawer = () => {
  return (
    <div className="w-[100px] md:w-[300px] border-r border-gray-200 dark:border-gray-700 overflow-y-auto pt-16 pl-4 flex flex-col items-start bg-white dark:bg-gray-800 shadow-lg">
