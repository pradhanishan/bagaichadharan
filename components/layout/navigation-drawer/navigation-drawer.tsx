...
const NavigationDrawer = () => {
  return (
    <div className="w-64 md:w-80 border-r border-gray-200 dark:border-gray-700 overflow-y-auto pt-16 pl-4 flex flex-col items-start bg-white dark:bg-gray-800 shadow-lg">
        ...
        <div key={`section-${index}`} className="mb-8">
          ...
          {section.items.map((item, itemIndex) => (
            <NavigationDrawerItem
              ...
              urls={item.urls} // Pass URLs to NavigationDrawerItem
            />
          ))}
        </div>
      ))}
