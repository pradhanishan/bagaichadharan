...
//       staffId: '',
//       areaId: '',
//       records: [{ productId: '', quantitySold: '0' }],
//     },
//   });
...
//       const menuItem = menuItems.find((item) => item.id === +record.productId);
//       if (menuItem) {
...
//               <Button
//                 type="button"
//                 onClick={() => append({ productId: '', quantitySold: '', amountSold: '' })}
...
//                         ? menuItems.find((menuItem) => menuItem.id === +item.productId)?.item || 'Unknown Item'
//                         : 'Currently Adding'}
//                     </TableCell>
...
//                     <TableCell className="px-6 py-3 text-sm dark:text-gray-300 w-1/5">
//                       {index !== fields.length - 1
//                         ? menuItems.find((menuItem) => menuItem.id === +item.productId)
//                           ? (
//                               (menuItems.find((menuItem) => menuItem.id === +item.productId)?.price || 0) *
